...
class EditPatientValidatorTest {
    ...
    public void shouldReturnEmptyList(){
        ...
        EditPatientRequest request = new EditPatientRequest(1L, SearchEnums.CHANGE_NAME, "Name");
    ...
    public void shouldReturnPatientIDError(){
        EditPatientRequest request = new EditPatientRequest(null, SearchEnums.CHANGE_NAME, "Name");
        List<CoreError> errorList = validator.validate(request);
    ...
    public void shouldReturnChangesError(){
        database.add(new Patient("name", "surname", "1234"));
        EditPatientRequest request = new EditPatientRequest(1L, SearchEnums.CHANGE_NAME, "");
        List<CoreError> errorsList = validator.validate(request);
        assertEquals(errorsList.size(), 1);
