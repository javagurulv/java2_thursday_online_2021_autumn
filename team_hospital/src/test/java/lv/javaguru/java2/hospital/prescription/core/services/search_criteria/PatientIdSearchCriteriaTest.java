...
class PatientIdSearchCriteriaTest {
    ...
    public void shouldReturnTrue() {
        SearchPrescriptionRequest request = new SearchPrescriptionRequest(null, null, 15L);
    ...
    public void shouldReturnCorrectPrescription() {
        ...
        Mockito.when(database.findByPatientId(patientId)).thenReturn(prescriptions);
        SearchPrescriptionRequest request = new SearchPrescriptionRequest(null, null, patientId);
