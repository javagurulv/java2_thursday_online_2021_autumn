...
class ExistenceByDoctorIdTest {

    @Mock private JpaVisitRepository repository;
    @InjectMocks private ExistenceByDoctorId existenceByDoctorId;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("", "12", "", "");
        assertTrue(existenceByDoctorId.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByDoctorId.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByDoctorId.validateExistence(request);
        assertTrue(error.isEmpty());
    }

    @Test
    public void shouldReturnError() {
        SearchVisitRequest request = new SearchVisitRequest("", "", "", "2023-12-12 12:00");
        Optional<CoreError> error = existenceByDoctorId.validateExistence(request);
