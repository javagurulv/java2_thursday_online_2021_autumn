...
class ExistenceByDoctorIdAndPatientIdAndDateTest {
    ...
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest(null, "122", "11", "27-12-2021 14:00");
    ...
    public void shouldReturnVisitError() {
        SearchVisitRequest request = new SearchVisitRequest(null, "1321","33", "27-12-2021 16:00");
    ...
    public void shouldReturnEmptyList() {
        ...
        SearchVisitRequest request =
                new SearchVisitRequest(null, doctorId.toString(), patientId.toString(), "27-12-2021 16:00");
