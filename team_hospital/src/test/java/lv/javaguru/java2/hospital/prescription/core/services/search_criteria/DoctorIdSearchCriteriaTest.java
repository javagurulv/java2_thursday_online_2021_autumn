...
class DoctorIdSearchCriteriaTest {
    ...
    @InjectMocks private DoctorIdSearchCriteria searchCriteria;

    @Test
    public void shouldReturnTrue() {
        SearchPrescriptionRequest request = new SearchPrescriptionRequest(null, 16L, null);
    ...
    public void shouldReturnCorrectPrescription() {
        ...
        Mockito.when(database.findByDoctorId(doctorId)).thenReturn(prescriptions);
        SearchPrescriptionRequest request = new SearchPrescriptionRequest(null, doctorId, null);
