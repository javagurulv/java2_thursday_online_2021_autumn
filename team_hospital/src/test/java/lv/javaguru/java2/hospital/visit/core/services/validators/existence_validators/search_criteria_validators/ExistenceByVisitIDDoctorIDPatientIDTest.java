...
class ExistenceByVisitIDDoctorIDPatientIDTest {

    @Mock
    private JpaVisitRepository repository;
    @InjectMocks
    private ExistenceByVisitIDDoctorIDPatientID existenceByVisitIDDoctorIDPatientID;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("12", "12", "12", "");
        assertTrue(existenceByVisitIDDoctorIDPatientID.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByVisitIDDoctorIDPatientID.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByVisitIDDoctorIDPatientID.validateExistence(request);
