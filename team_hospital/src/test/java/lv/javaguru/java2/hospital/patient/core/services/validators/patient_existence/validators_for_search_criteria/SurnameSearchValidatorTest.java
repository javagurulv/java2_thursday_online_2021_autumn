...
import lv.javaguru.java2.hospital.patient.core.services.validators.patient_existence.existence_validators_for_search_criteria.SurnameSearchValidator;
...
class SurnameSearchValidatorTest {

    private PatientDatabaseImpl database = new PatientDatabaseImpl();
    private SurnameSearchValidator validator = new SurnameSearchValidator(database);
