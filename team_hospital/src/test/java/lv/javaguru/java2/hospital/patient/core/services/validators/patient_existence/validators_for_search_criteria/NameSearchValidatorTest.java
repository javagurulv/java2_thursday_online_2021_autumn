...
import lv.javaguru.java2.hospital.patient.core.services.validators.patient_existence.existence_validators_for_search_criteria.NameSearchValidator;
...
class NameSearchValidatorTest {

    private PatientDatabase database = new PatientDatabaseImpl();
    private NameSearchValidator validator = new NameSearchValidator(database);
