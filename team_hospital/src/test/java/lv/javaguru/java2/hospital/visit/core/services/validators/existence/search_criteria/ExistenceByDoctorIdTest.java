...
import lv.javaguru.java2.hospital.visit.core.services.validators.existence_validators.search_criteria_validators.ExistenceByDoctorId;
...
class ExistenceByDoctorIdTest {
    ...
    @InjectMocks
    private ExistenceByDoctorId existence;
