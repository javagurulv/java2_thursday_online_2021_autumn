...
class ExistenceByVisitIDAndDoctorIDTest {

    @Mock private VisitRepository repository;
    @InjectMocks private ExistenceByVisitIDAndDoctorID existenceByVisitIDAndDoctorID;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("12", "12", "", "");
        assertTrue(existenceByVisitIDAndDoctorID.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByVisitIDAndDoctorID.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByVisitIDAndDoctorID.validateExistence(request);
