...
class PrescriptionExistenceByDoctorIdTest {

    @Mock
    private JpaPrescriptionRepository database;
    @InjectMocks
    private PrescriptionExistenceByDoctorId existence;

    @Test
    public void shouldReturnTrue() {
        SearchPrescriptionRequest request = new SearchPrescriptionRequest(null, 77L, null);
