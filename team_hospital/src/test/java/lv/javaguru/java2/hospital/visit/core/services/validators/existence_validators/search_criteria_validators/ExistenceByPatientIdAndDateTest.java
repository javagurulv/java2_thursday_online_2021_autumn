...
class ExistenceByPatientIdAndDateTest {
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByPatientIdAndDate.validateExistence(request);
