...
class ExistenceByVisitIdTest {
    ...
    @InjectMocks
    private ExistenceByVisitId existenceByVisitId;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "", "");
        assertTrue(existenceByVisitId.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByVisitId.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByVisitId.validateExistence(request);
