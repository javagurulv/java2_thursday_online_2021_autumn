...
class ExistenceByVisitIDAndPatientIDTest {

    @Mock private VisitRepository repository;
    @InjectMocks private ExistenceByVisitIDAndPatientID existenceByVisitIDAndPatientID;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "");
        assertTrue(existenceByVisitIDAndPatientID.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByVisitIDAndPatientID.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByVisitIDAndPatientID.validateExistence(request);
