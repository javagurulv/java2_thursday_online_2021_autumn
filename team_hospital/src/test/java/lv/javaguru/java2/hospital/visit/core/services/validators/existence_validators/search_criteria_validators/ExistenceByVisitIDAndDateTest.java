...
class ExistenceByVisitIDAndDateTest {
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByVisitIDAndDate.validateExistence(request);
