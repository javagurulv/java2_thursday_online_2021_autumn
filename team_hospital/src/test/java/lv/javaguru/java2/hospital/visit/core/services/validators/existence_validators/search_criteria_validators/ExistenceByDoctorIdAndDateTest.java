...
class ExistenceByDoctorIdAndDateTest {
    ...
    @InjectMocks private ExistenceByDoctorIdAndDate existenceByDoctorIdAndDate;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("", "12", "", "2023-12-12 12:00");
        assertTrue(existenceByDoctorIdAndDate.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByDoctorIdAndDate.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByDoctorIdAndDate.validateExistence(request);
