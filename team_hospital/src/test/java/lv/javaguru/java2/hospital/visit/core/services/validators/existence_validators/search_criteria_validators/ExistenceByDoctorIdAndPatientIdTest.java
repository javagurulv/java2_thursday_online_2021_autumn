...
class ExistenceByDoctorIdAndPatientIdTest {
    ...
    @InjectMocks
    private ExistenceByDoctorIdAndPatientId existenceByDoctorIdAndPatientId;

    @Test
    public void shouldReturnTrue() {
        SearchVisitRequest request = new SearchVisitRequest("", "12", "12", "");
        assertTrue(existenceByDoctorIdAndPatientId.canValidate(request));
    }

    @Test
    public void shouldReturnFalse() {
        SearchVisitRequest request = new SearchVisitRequest("12", "", "12", "2023-12-12 12:00");
        assertFalse(existenceByDoctorIdAndPatientId.canValidate(request));
    }
    ...
    public void shouldReturnList() {
        ...
        Optional<CoreError> error = existenceByDoctorIdAndPatientId.validateExistence(request);
        assertTrue(error.isEmpty());
    }

    @Test
    public void shouldReturnError() {
        SearchVisitRequest request = new SearchVisitRequest("", "12", "", "2023-12-12 12:00");
        Optional<CoreError> error = existenceByDoctorIdAndPatientId.validateExistence(request);
