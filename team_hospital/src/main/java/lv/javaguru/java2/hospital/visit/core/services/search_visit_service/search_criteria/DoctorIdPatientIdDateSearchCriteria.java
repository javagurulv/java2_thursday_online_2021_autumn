...
public class DoctorIdPatientIdDateSearchCriteria implements VisitsSearchCriteria{

    private final JpaVisitRepository database;
    private final GetVisitDate getVisitDate;

    public DoctorIdPatientIdDateSearchCriteria(JpaVisitRepository database, GetVisitDate getVisitDate) {
