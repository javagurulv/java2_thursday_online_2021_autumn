...
public class PrescriptionProgramMenu {
    ...
    public PrescriptionProgramMenu(List<PrescriptionUIAction> uiActions) {
        ...
        menuNumberToUIActionMap.put(5, findUIAction(uiActions, SearchPrescriptionUIAction.class));
        menuNumberToUIActionMap.put(6, findUIAction(uiActions, ExitPrescriptionUIAction.class));
    }
