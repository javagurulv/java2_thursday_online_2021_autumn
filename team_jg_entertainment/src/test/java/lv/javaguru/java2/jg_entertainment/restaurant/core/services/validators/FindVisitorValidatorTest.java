...
class FindVisitorValidatorTest {
    ...
    void coreErrorsNotEmpty() {
        FindVisitorInformationRequest request = new FindVisitorInformationRequest(2L, "Olga");
    ...
    void coreErrorsHaveEmptyName() {
        FindVisitorInformationRequest request = new FindVisitorInformationRequest(1L, "");
        List<CoreError> coreErrorList = visitorValidator.coreErrors(request);
    ...
    void coreErrorsHaveNullTelephoneNumber() {
        FindVisitorInformationRequest request = new FindVisitorInformationRequest(null, "Olga");
        List<CoreError> coreErrorList = visitorValidator.coreErrors(request);
        assertEquals(coreErrorList.size(), 1);
