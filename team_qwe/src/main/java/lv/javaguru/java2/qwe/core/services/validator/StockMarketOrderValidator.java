...
@Component
public class StockMarketOrderValidator {
    ...
    public List<CoreError> validate(StockMarketOrderRequest request) {
    ...
    private boolean checkPresence(StockMarketOrderRequest request) {
