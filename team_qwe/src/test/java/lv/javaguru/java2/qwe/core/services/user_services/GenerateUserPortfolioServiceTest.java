...
public class GenerateUserPortfolioServiceTest {
    ...
    public void shouldReturnGeneratedUserPortfolio() {
        ...
        List<Position> portfolio = List.of(
                ...
                new Position(new Stock("APA Corp.", "Energy", "USD", 16.07, 0.62, 2), 3267, 16.07),
                new Position(new Stock("Occidental Petroleum Corporation", "Energy", "USD", 21.95, 0.18, 1.69), 2392, 21.95),
                new Position(new Stock("Sysco Corporation", "Consumer Staples", "USD", 76.79, 2.45, 1.66), 98, 76.79),
                ...
                new Position(new Stock("Freeport-McMoRan Inc.", "Materials", "USD", 32.8, 0.91, 1.59), 1372, 32.8),
                new Position(new Stock("LyondellBasell Industries NV", "Materials", "USD", 98.21, 4.6, 1.4), 458, 98.21),
                new Position(new Stock("Lincoln National Corporation", "Financials", "USD", 65.81, 2.55, 2.17), 912, 65.81),
                ...
                new Position(new Stock("Boeing Company", "Industrials", "USD", 212.67, 0, 2.18), 353, 212.67),
                new Position(new Stock("United Airlines Holdings Inc.", "Industrials", "USD", 44.03, 0, 1.98), 1703, 44.03),
                new Position(new Stock("Caesars Entertainment Inc", "Consumer Discretionary", "USD", 85.64, 0, 2.93), 1022, 85.64),
                new Position(new Stock("Penn National Gaming Inc.", "Consumer Discretionary", "USD", 67.65, 0, 2.33), 1293, 67.65),
                new Position(new Cash(), 360.37, 1)
        );
